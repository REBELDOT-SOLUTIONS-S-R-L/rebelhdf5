...
export function getDatasetComparisonLink(href: string): string {
  return getFileLink('/dataset-comparison', href);
}

export function getDatasetAttributesLink(href: string): string {
